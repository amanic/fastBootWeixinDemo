...
package com.amateur.wanbei.service.module.menu;

import com.amateur.wanbei.service.annotation.WxButton;
import com.amateur.wanbei.service.exception.WxApiResultException;
...
public class WxMenuManager implements EnvironmentAware, ApplicationListener<ApplicationReadyEvent> {
    ...
    public static class WxMenu {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.module.menu.WxMenuManager.WxMenu(mainButtons=" + this.mainButtons + ")";
        }
    }
    ...
    public static class WxMenus {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.menu.WxMenuManager.WxMenus(wxMenu=" + this.wxMenu + ", conditionalWxMenu=" + this.conditionalWxMenu + ")";
        }
    }
}
