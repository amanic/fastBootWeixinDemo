...
import com.amateur.wanbei.service.module.media.*;
    ...
    private static class StoreEntity implements Serializable {
        ...
        public static class Builder {
            ...
            public String toString() {
                return "com.amateur.wanbei.service.support.MapDbWxMediaStore.StoreEntity.Builder(resourcePath=" + this.resourcePath + ", mediaId=" + this.mediaId + ", mediaUrl=" + this.mediaUrl + ", createdTime=" + this.createdTime + ", modifiedTime=" + this.modifiedTime + ", mediaType=" + this.mediaType + ")";
            }
        }
    }
