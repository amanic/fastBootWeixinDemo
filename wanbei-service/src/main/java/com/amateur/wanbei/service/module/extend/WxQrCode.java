...
public class WxQrCode {
    ...
    public static class Builder {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.module.extend.WxQrCode.WxQrCodeBuilder(expireSeconds=" + this.expireSeconds + ", action=" + this.action + ", actionInfo=" + this.actionInfo + ")";
        }
    }
