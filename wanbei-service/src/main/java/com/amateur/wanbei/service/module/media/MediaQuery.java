...
public class MediaQuery {
    ...
    public static class MediaQueryBuilder {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.module.media.MediaQuery.MediaQueryBuilder(key=" + this.key + ", resourcePath=" + this.resourcePath + ", resourceUrl=" + this.resourceUrl + ", modifiedTime=" + this.modifiedTime + ", mediaId=" + this.mediaId + ", mediaUrl=" + this.mediaUrl + ", type=" + this.type + ", createdTime=" + this.createdTime + ", isTemp=" + this.storeType + ")";
        }
    }
}
