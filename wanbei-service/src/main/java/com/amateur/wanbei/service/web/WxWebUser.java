...
package com.amateur.wanbei.service.web;
...
public class WxWebUser implements Serializable {
    ...
    public String toString() {
        return "com.amateur.wanbei.service.web.WxWebUser(accessToken=" + this.getAccessToken() + ", expiresIn=" + this.getExpiresIn() + ", refreshToken=" + this.getRefreshToken() + ", openId=" + this.getOpenId() + ", scope=" + this.getScope() + ", createTime=" + this.getCreateTime() + ")";
    }
}
