...
package com.amateur.wanbei.service.module.credential;
...
public class WxAccessToken implements WxCredential {
    ...
    public String toString() {
        return "com.amateur.wanbei.service.module.credential.WxAccessToken(accessToken=" + this.getAccessToken() + ", expiresIn=" + this.getExpiresIn() + ")";
    }
}
