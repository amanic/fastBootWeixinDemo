...
package com.amateur.wanbei.service.module.message;
...
public class WxMessageBody {
    ...
    public static class Media extends WxMessageBody {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.module.message.WxMessage.Media(mediaId=" + this.getMediaId() + ", mediaPath=" + this.getMediaPath() + ", mediaUrl=" + this.getMediaUrl() + ")";
        }
    }
    ...
    public static class Image extends Media {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.message.WxMessage.Image.WxMessageBody()";
        }
    }
    ...
    public static class Voice extends Media {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.message.WxMessage.Voice.WxMessageBody()";
        }
    }
    ...
    public static class Video extends Media {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.message.WxMessage.Video.WxMessageBody(thumbMediaId=" + this.getThumbMediaId() + ", title=" + this.getTitle() + ", description=" + this.getDescription() + ", thumbMediaPath=" + this.getThumbMediaPath() + ", thumbMediaUrl=" + this.getThumbMediaUrl() + ")";
        }
    }
    ...
    public static class Music extends Media {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.message.WxMessage.Music.WxMessageBody(thumbMediaId=" + this.getThumbMediaId() + ", title=" + this.getTitle() + ", description=" + this.getDescription() + ", musicUrl=" + this.getMusicUrl() + ", hqMusicUrl=" + this.getHqMusicUrl() + ")";
        }
    }
    ...
    public static class Template extends WxMessageBody implements Map<String, Template.TemplateData> {
        ...
        @Override
        public Set<Entry<String, TemplateData>> entrySet() {
