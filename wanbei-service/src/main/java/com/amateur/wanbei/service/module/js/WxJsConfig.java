...
package com.amateur.wanbei.service.module.js;

import com.amateur.wanbei.service.util.CryptUtils;
...
public class WxJsConfig {
    ...
    public static class Builder {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.module.js.WxJsConfig.Builder(debug=" + this.debug + ", appId=" + this.appId + ", timestamp=" + this.timestamp + ", nonceStr=" + this.nonceStr + ", url=" + this.url + ", jsApiList=" + this.jsApiList + ")";
        }
    }
}
