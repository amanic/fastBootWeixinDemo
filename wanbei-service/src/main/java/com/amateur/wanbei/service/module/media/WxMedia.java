...
package com.amateur.wanbei.service.module.media;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.fasterxml.jackson.databind.annotation.JsonSerialize;
import com.amateur.wanbei.service.module.adapter.WxJsonAdapters;
...
public class WxMedia {
    ...
    public String toString() {
        return "com.amateur.wanbei.service.module.media.WxMedia(mediaId=" + this.getMediaId() + ")";
    }
    ...
    public static class TempMediaResult implements Result {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.TempMediaResult(type=" + this.getType() + ", mediaId=" + this.getMediaId() + ", createdAt=" + this.getCreatedAt() + ")";
        }
    }
    ...
    public static class MediaResult implements Result {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.MediaResult(url=" + this.getUrl() + ", mediaId=" + this.getMediaId() + ")";
        }
    }
    ...
    public static class ImageResult implements Result {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.ImageResult(url=" + this.getUrl() + ")";
        }
    }
    ...
    public static class NewsResult implements Result {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.NewsResult(mediaId=" + this.getMediaId() + ")";
        }
    }
    ...
    public static class Video implements Serializable {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.Video(title=" + this.getTitle() + ", introduction=" + this.getIntroduction() + ", downUrl=" + this.getDownUrl() + ")";
        }
    ...
    public static class New {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.New(mediaId=" + this.getMediaId() + ", index=" + this.getIndex() + ", article=" + this.getArticle() + ")";
        }
    ...
    public static class Article {
        ...
        @Override
        public String toString() {
            return "com.amateur.wanbei.service.module.media.WxMedia.Article(title=" + this.getTitle() + ", thumbMediaId=" + this.getThumbMediaId() + ", showCoverPic=" + this.isShowCoverPic() + ", content=" + this.getContent() + ", contentSourceUrl=" + this.getContentSourceUrl() + ", author=" + this.getAuthor() + ", digest=" + this.getDigest() + ", url=" + this.getUrl() + ")";
        }
