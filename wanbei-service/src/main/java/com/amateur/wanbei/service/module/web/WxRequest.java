...
package com.amateur.wanbei.service.module.web;


import com.amateur.wanbei.service.annotation.WxButton;
import com.amateur.wanbei.service.module.Wx;
import com.amateur.wanbei.service.module.adapter.WxXmlAdapters;
...
public class WxRequest {
    ...
    public static class Body {
        ...
        public static class ScanCodeInfo {
            ...
            @Override
            public String toString() {
                return "com.amateur.wanbei.service.module.web.WxRequest.WxMessageBody.ScanCodeInfo(scanType=" + this.getScanType() + ", scanResult=" + this.getScanResult() + ")";
            }
        }
        ...
        public static class SendPicsInfo {
            ...
            @Override
            public String toString() {
                return "com.amateur.wanbei.service.module.web.WxRequest.WxMessageBody.SendPicsInfo(count=" + this.getCount() + ", picList=" + this.getPicList() + ")";
            }
            ...
            public static class Item {
                ...
                @Override
                public String toString() {
                    return "com.amateur.wanbei.service.module.web.WxRequest.WxMessageBody.SendPicsInfo.Item(picMd5Sum=" + this.getPicMd5Sum() + ")";
                }
            }
        }
        ...
        public static class SendLocationInfo {
            ...
            @Override
            public String toString() {
                return "com.amateur.wanbei.service.module.web.WxRequest.WxMessageBody.SendLocationInfo(locationX=" + this.getLocationX() + ", locationY=" + this.getLocationY() + ", scale=" + this.getScale() + ", label=" + this.getLabel() + ", poiname=" + this.getPoiname() + ")";
            }
        }
