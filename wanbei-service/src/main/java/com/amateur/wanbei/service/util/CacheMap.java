...
public class CacheMap<K, V> extends AbstractMap<K, V> {
    ...
    public static class Builder<K, V> {
        ...
        public String toString() {
            return "com.amateur.wanbei.service.util.CacheMap.CacheMapBuilder(cacheTimeout=" + this.cacheTimeout + ", entryMap=" + this.entryMap + ", cacheName=" + this.cacheName + ", refreshOnRead=" + this.refreshOnRead + ", maxSize=" + this.maxSize + ")";
        }
    }
